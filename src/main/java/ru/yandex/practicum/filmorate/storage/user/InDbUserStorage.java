...
public class InDbUserStorage implements UserStorage {
    ...
    @Override
    public void addFriend(int followedId, int followerId) {
        ...
        if (userRows.first()) {
            jdbcTemplate.update(sqlForUpdateQuery, Friendship.CONFIRMED.toString(), followedId, followerId);
        } else {
            jdbcTemplate.update(sqlForWriteQuery, followedId, followerId, Friendship.REQUIRED.toString());
        }
    ...
    @Override
        public void deleteFriend(int followedId, int followerId) {
    ...
    @Override
    public List<User> getCommonFriends(int followedId, int followerId) {
        validate(followedId, followerId);
        final String sqlQuery = "SELECT id, email, login, name, birthday " +
